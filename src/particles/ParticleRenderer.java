...
public class ParticleRenderer {
	...
	private FloatBuffer floatBuffer = BufferUtils.createFloatBuffer(MAX_INSTANCES * INSTANCE_DATA_LENGTH);
	...
	protected ParticleRenderer(Loader loader, Matrix4f projectionMatrix){
		...
		loader.addInstance(quad.getVaoID(),vbo,1,4,INSTANCE_DATA_LENGTH,0);
		loader.addInstance(quad.getVaoID(),vbo,2,4,INSTANCE_DATA_LENGTH,4);
		loader.addInstance(quad.getVaoID(),vbo,3,4,INSTANCE_DATA_LENGTH,8);
		loader.addInstance(quad.getVaoID(),vbo,4,4,INSTANCE_DATA_LENGTH,12);
		loader.addInstance(quad.getVaoID(),vbo,5,4,INSTANCE_DATA_LENGTH,16);
		loader.addInstance(quad.getVaoID(),vbo,6,1,INSTANCE_DATA_LENGTH,20);
