...
public class Terrain {
    ...
    public static Terrain calculateTerrain(List<Terrain> terrains, Vector3f position){
        ...
        for(Terrain terrain:terrains) {
            ...
            }else if(Math.abs((int)position.x / (int)terrain.getX()) == 0 && terrain.getX()<0 || (int)position.x / (int)SIZE == (int)terrain.getX() / (int)SIZE && terrain.getX()>0){
                x = true;
            }
            if(terrain.getZ() == 0) {
            ...
            }else if(Math.abs((int)position.z / (int)terrain.getZ()) == 0 && terrain.getZ()<0 || (int)position.z / (int)SIZE == (int)terrain.getZ() / (int)SIZE && terrain.getZ()>0){
                z = true;
            }
            if(x && z){
                return terrain;
